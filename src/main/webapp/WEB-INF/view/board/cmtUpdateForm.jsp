...
<body><%@ include file="/WEB-INF/resources/header_left.jsp" %>
...
<div class="table_div">
<form  action="${pageContext.request.contextPath}/cmt_update_req" method="post" id="myForm" onsubmit="return confirm('댓글을 수정 하시겠습니까?');">
...
<textarea rows="5" cols="30" style="margin: 0px;
    ...
    height: 120px;
    resize: none;"
    name="cmt_content" id ="cmt_textarea">${cmt.cmt_content}</textarea>
</td>
<td style="width:15%; height:100%; text-align: left;"><input type="submit" value="작성완료" id="submit_btn"/><label id = "count_label">(0/150자)</label>
<input type="button" onclick="cancle();" value="수정취소">
</td>
