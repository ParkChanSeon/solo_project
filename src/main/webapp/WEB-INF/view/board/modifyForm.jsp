...
<form action = "${pageContext.request.contextPath}/modifyRequest" method="POST" class="write_form">
...
<label>TITLE</label>
<input type="text" class="form-control" style="display:inline-block; width:80%;" required="required" name="article_title" value="${article.article_title}">
</div>
<div class="form-group">
<textarea rows="20" cols="60" class="form-control" name="article_content" 
style="resize:none; display:inline-block; width:700px;" required="required" >${article.article_content}</textarea>
</div>
